...
class CompletedAppointment extends Appointment {
  int id = 0;
  int patientId = 0;
  int pharmacyId = 0;
  int doctorId = 0;
  ...
  @override
  String toString() {
    return 'CompletedAppointment{id: $id, patientId: $patientId, pharmacyId: $pharmacyId, doctorId: $doctorId, specialistId: $specialistId, slotId: $slotId, requestedBy: $requestedBy, requestTime: $requestTime, appointmentDate: $appointmentDate, appointmentTime: $appointmentTime, meetLink: $meetLink, meetLinkTime: $meetLinkTime, doctorForAppointment: $doctorForAppointment, patientForAppointment: $patientForAppointment}';
  }
}
