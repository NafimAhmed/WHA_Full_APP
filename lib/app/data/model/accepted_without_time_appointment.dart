...
class AcceptedWithoutTimeAppointment extends Appointment {
  int id = 0;
  int patientId = 0;
  int pharmacyId = 0;
  int doctorId = 0;
  ...
  @override
  String toString() {
    return 'AcceptedWithoutTimeAppointment{id: $id, patientId: $patientId, pharmacyId: $pharmacyId, doctorId: $doctorId, specialistId: $specialistId, slotId: $slotId, requestedBy: $requestedBy, requestTime: $requestTime, doctorForAppointment: $doctorForAppointment, patientForAppointment: $patientForAppointment}';
  }
}
