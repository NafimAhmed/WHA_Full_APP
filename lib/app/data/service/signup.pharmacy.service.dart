...
class SignupPharmacyService {
  final AppState appState = Get.find<AppState>();
  final Uri _signupPharmacy = Uri.parse(Api.signupPharmacy);
  ...
  Future<bool> signupPharmacy(
    ...
    try {
      _response = await http.post(_signupPharmacy,
          headers: _headers, body: jsonEncode(_body));
      log('signup pharmacy response: ${_response.statusCode}');
