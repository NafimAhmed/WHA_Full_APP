...
import 'package:wha/app/modules/patient/p_confirm_patient_details_module/widgets/widgets.dart';
import 'package:wha/app/theme/app_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:get/get.dart';

class PConfirmPatientDetailsPage
    extends GetView<PConfirmPatientDetailsController> {
  const PConfirmPatientDetailsPage({Key? key}) : super(key: key);
                      ...
                      child: Column(
                        children: [
                          ...
                          SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                BuildPatientCard(patient: controller.patient),
                                BuildPurposeOfVisit(
