...
class PSettingsPage extends StatefulWidget/*GetView<PSettingsController>*/{
  @override
  State<PSettingsPage> createState() => _PSettingsPageState();
}

class _PSettingsPageState extends State<PSettingsPage> {
  //const PSettingsPage({Key? key}) : super(key: key);
