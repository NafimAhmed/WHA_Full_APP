...
class BuildCallingAppointment extends StatelessWidget {
  const BuildCallingAppointment({Key? key, required this.appointment}) : super(key: key);
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Spacer(),
                  BuildAppointmentJoinButton(appointment: appointment),
                ],
              ),
            ),
