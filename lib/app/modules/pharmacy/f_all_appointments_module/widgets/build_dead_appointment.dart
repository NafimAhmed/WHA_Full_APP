...
class BuildDeadAppointment extends StatelessWidget {
  const BuildDeadAppointment({Key? key, required this.appointment})
      : super(key: key);
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Spacer(),
                  // BuildAppointmentDeleteButton(appointment: appointment),
                ],
              ),
            ),
