...
class FChooseADoctorPage extends GetView<FChooseADoctorController> {
  const FChooseADoctorPage({Key? key}) : super(key: key);
                      ...
                      children: [
                        Obx(() {
                          ...
                          return BuildDoctorList(
                              ...
                              doctors: (controller.doctors as List<DoctorForAppointment>));
                        }),
                      ],
                    ),
                  ),
