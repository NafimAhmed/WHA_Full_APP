...
class FAppointmentSubmitFeedbackPage extends GetView<FAppointmentSubmitFeedbackController> {
  const FAppointmentSubmitFeedbackPage({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: () {
            Get.offNamedUntil(Routes.F_DASHBOARD, (route) => false);
          },
          child: Center(
